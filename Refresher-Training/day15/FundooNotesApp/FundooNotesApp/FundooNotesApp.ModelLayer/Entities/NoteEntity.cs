...
public class NoteEntity
{
    ...
    // Optional - lets a note carry a reminder date/time (feature-only,
    // we don't send notifications yet, just store when it's due).
    ...
    // Three independent status flags a note can carry. See NoteCommandBL for
