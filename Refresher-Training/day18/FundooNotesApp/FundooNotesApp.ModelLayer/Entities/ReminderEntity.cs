...
public class ReminderEntity
{
    ...
    // Flips to true the moment the ReminderScannerService background
    // service has fired the notification email for this reminder -
    // stops the same reminder from being emailed twice on the next scan.
